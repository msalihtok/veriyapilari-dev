...
public class Huffman {
	...
	public HashMap<Character, Integer> hmapWC; 
	public HashMap<Character, String> hmapCode; 
	...
	public Huffman(String orgStr, boolean show, String dotfilename){
		...
		countWord();  // Adım 1: Kelime Sayıcı
		buildTree();  // Adım 2: Huffman Algoritmasını İnşaa eder
		
		buildCodeTable();  // Adım 3: Huffman kod tablosunu Oluşturur
	}
